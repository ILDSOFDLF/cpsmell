...
from utils.test import astChecker2
...
if __name__ == '__main__':
    ...
    # print(is_python3)
    myast=astChecker2.MyAst()
    myast.fileName="__init__.py"
    astContent=parse_file("F:\\python_workplace\\tensorflow-master\\tensorflow\\lite\\python\\optimize\\calibrator.py")
    astContent2=parse_file("F:\\python_workplace\\pytorch-master\\torch\\utils\\benchmark\\utils\\cpp_jit.py")
    astContent3=parse_file("F:\\python_workplace\\mindspore-master\\mindspore\\lite\python\\api\\context.py")
    astContent4=parse_file("F:\\python_workplace\\mindspore-master\\mindspore\\lite\\python\\api\\tensor.py")
    astContent5=parse_file("F:\\python_workplace\\mindspore-master\\mindspore\\python\\mindspore\\mindrecord\\shardutils.py")
    astContent6=parse_file("F:\\python_workplace\\mindspore-master\\mindspore\\python\\mindspore\\common\\api.py")
    astContent7=parse_file("F:\\python_workplace\\mindspore-master\\mindspore\\python\\mindspore\\ops\\composite\\base.py")
    astContent8=parse_file("F:\\python_workplace\\mindspore-master\\mindspore\\python\\mindspore\\common\\_stub_tensor.py")
    astContent9=parse_file("F:\\python_workplace\\Paddle-develop\\python\\paddle\\fluid\\dygraph\\tracer.py")
    astContent10=parse_file("F:\\python_workplace\\Paddle-develop\\python\\paddle\\hapi\\model.py")
    astContent11=parse_file("F:\\python_workplace\\pytorch-master\\torch\\testing\\_internal\\common_utils.py")
    astContent12=parse_file("F:\\python_workplace\\chainer-master\\tests\\chainerx_tests\\unit_tests\\test_backprop_mode.py")
    astContent13=parse_file("F:\\DLFs_dataset\\pytorch\\pytorch-2.0.1\\torch\\__init__.py")
    astContent14=parse_file("F:\\DLFs_dataset\\pytorch\\pytorch-2.0.1\\torch\\_inductor\\codecache.py")
    astContent15=parse_file("F:\\DLFs_dataset\\pytorch\\pytorch-2.0.1\\torch\\cuda\\__init__.py")
    astContent16=parse_file("F:\\DLFs_dataset\\tensorflow\\tensorflow-2.12.0\\tensorflow\\tools\\test\\gpu_info_lib.py")

    # print(astContent)
    # print(ast.dump(astContent))
    myast.visit(astContent16)
    # print(astContent2)
    # print(ast.dump(astContent10))

    astpretty.pprint(astContent16)
    print("------------------------------------------------------------")
    for item in myast.load_cdll:
        print(item)

    # for defitem in myast.constant:
    #     print(defitem)
