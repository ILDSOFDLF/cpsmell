...
class MyAst(ast.NodeVisitor):
    ...
    def visit_ListComp(self,node):
        ...
        _ast.ExtSlice,_ast.Index,_ast.And,_ast.Or,
    ...
    def visit_Attribute(self,node):
      ...
      #     attr_node=v.value
      #     if isinstance(attr_node,_ast.Name) and v.id == self.call_module:
      #         print("-----------------------")
      #         print(attr_node.attr)
      #         if v.attr is not None:
      #             self.component.add((attr_node.attr,v.attr))
      #
      # if isinstance(v,_ast.Name) and v.id == self.call_module:
      #     print("===========================")
      #     print(node.attr)
      # v = node.value
      # if isinstance(v, _ast.Attribute):
      ...
      #         print(v.attr)
      #         if v.attr is not None:
      #             self.component.add((v.attr, node.attr))
      #
      # if isinstance(v, _ast.Name) and v.id == self.call_module:
      #     print("===========================")
      #     print(node.attr)
      #     self.component.add(node.attr)
      # self.generic_visit(node)
      v = node.value
      if isinstance(v, _ast.Attribute):
          attr_node = v.value
